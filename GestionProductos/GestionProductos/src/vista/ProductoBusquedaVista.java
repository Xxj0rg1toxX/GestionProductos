...
public class ProductoBusquedaVista extends JFrame implements IProductoBusquedaVista {
    ...
    private void initComponents() {
        ...
        btnBuscarNombre = boton("Buscar por nombre", "NOMBRE");
        ...
        btnBuscarTipo = boton("Buscar por tipo", "TIPO");
        ...
        btnBuscarProveedor = boton("Buscar por proveedor", "PROVEEDOR");
        ...
        btnVerTodos  = boton("Ver todos", "TODOS");
        btnModificar = boton("Modificar", "MODIFICAR");
        btnEliminar  = boton("Eliminar", "ELIMINAR");
        btnCrear     = boton("Nuevo producto", "CREAR");
    ...
    private JButton boton(String texto, String command) {
